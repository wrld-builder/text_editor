...
struct qt_meta_stringdata_HtmlHighLighter_t {
    QByteArrayData data[1];
    char stringdata0[16];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_HtmlHighLighter_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_HtmlHighLighter_t qt_meta_stringdata_HtmlHighLighter = {
    {
QT_MOC_LITERAL(0, 0, 15) // "HtmlHighLighter"
...
QT_INIT_METAOBJECT const QMetaObject HtmlHighLighter::staticMetaObject = { {
    &QSyntaxHighlighter::staticMetaObject,
    qt_meta_stringdata_HtmlHighLighter.data,
    qt_meta_data_HtmlHighLighter,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *HtmlHighLighter::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_HtmlHighLighter.stringdata0))
